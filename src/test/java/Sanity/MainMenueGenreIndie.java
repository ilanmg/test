...
public class MainMenueGenreIndie extends SeleniumTestWrapper {
    ...
    public void MainMenueGenreIndie() throws InterruptedException {

        mainMenue.clickOnmainMenuGenre();
        Thread.sleep(2000);
        mainMenue.clickOnmainMenuGenreIndie();
        Thread.sleep(2000);

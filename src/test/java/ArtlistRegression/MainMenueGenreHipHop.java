...
public class MainMenueGenreHipHop extends SeleniumTestWrapper {
    ...
    @Test(groups ={"Artlist"}, description= "the script should click main menue Genre Pop")
    public void MainMenueGenrePop() throws InterruptedException {

        mainMenue.clickOnmainMenuGenre();
        Thread.sleep(2000);
        mainMenue.clickOnmainMenuGenrePop();
        Thread.sleep(2000);
